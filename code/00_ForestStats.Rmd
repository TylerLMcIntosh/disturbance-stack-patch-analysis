...
#Set outdirectory
if(computing == "local") {
  outDirT <- here::here("data", "derived")
  if (!dir.exists(outDirT)){
    dir.create(outDirT)
  }
} else if(computing == "cyverse") {
  outDirT <- "~/data-store/data/iplant/home/shared/earthlab/macrosystems/disturbance-stack-patch-analysis/"
  if (!dir.exists(outDirT)){
    dir.create(outDirT)
  }
}
...
if(computing == "local") {
  readr::write_csv(forestL4Stats, here::here('data', 'derived', 'forest_l4_dats.csv'))
  readr::write_csv(forestL3Stats, here::here('data', 'derived', 'forest_l3_dats.csv'))
} else if(computing == "cyverse") {
  readr::write_csv(forestL4Stats, '~/data-store/data/iplant/home/shared/earthlab/macrosystems/disturbance-stack-patch-analysis/derived/forest_l4_dats.csv')
  readr::write_csv(forestL3Stats, '~/data-store/data/iplant/home/shared/earthlab/macrosystems/disturbance-stack-patch-analysis/derived/forest_l3_dats.csv')
}
