...
calculate.metrics.for.raster.aoi.set <- function(rasterFileName, aoiSet, setNm, freqsOnly, verbose = FALSE, metricMergeThresh = NA, metricIgnore = NA) { 
...
calculate.raster.metrics <- function(raster, aoi, setNm, freqsOnly, verbose = FALSE, metricMergeThresh = NA, metricIgnore = NA) {
